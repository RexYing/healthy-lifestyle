...
public interface Consts {
     ...
     */
    public static final String PROJECT_ID = "enhanced-casing-363";

    /**
     * Set Project Number of your Google APIs Console Project.
     */
    public static final String PROJECT_NUMBER = "826011387300";

    /**
     * Set your Web Client ID for authentication at backend.
     */
    public static final String WEB_CLIENT_ID = "826011387300.apps.googleusercontent.com";
